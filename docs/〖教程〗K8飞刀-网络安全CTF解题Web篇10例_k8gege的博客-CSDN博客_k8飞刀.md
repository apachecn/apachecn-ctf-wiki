...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-f67zwqph-1626362672584)(http://k8gege.org/k8img/k8fly/ctf/ctf_post.PNG)]
...
![image](img/0f36340fc1ab5b3b998b3faf6f3e9d6e.png)
复制使用K8飞刀解密后得到Value值
